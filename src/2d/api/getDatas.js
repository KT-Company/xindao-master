  ...
  Promise.all([getParamsA(), getParamsB(), getParamsC(), getParamsD()]).then(res => {
    ...
    Promise.all([
      ...
      if (store.state.isMock) {
        ...
        // 企业库存情况
        data[4].data.data = [
          { "materialCode": "RM01005RM01005", "materialName": "玉龙X4mini 遥控飞机航拍器", "quantity": 4500 },
          { "materialCode": "RM01005RM01005", "materialName": "PP塑料机架壳MINI", "quantity": 4000 },
          { "materialCode": "RM01005RM01005", "materialName": "PP螺旋桨", "quantity": 1111 },
          { "materialCode": "RM01005RM01005", "materialName": "飞控主机主板", "quantity": 4000 },
          { "materialCode": "RM01004", "materialName": "玉龙X4mini钢机架", "quantity": 4000 },
          { "materialCode": "RM01005", "materialName": "无刷动力套装A", "quantity": 4000 },
          { "materialCode": "RM01006", "materialName": "MINI遥控器", "quantity": 4000 },
          { "materialCode": "RM01007", "materialName": "4K高清云图套件", "quantity": 4000 },
          { "materialCode": "RM01008", "materialName": "MINI包装套件", "quantity": 4000 }]
        // 增长
      ...
      const data1 = {
        ...
        qykcqk: {
          x: data[4].data.data.map(item => item.materialCode),
          data: data[4].data.data.map(item => item.quantity)
        },

        kdj: {
          x: Object.keys(data[14].data.data),
          data: Object.values(data[14].data.data)
        ...
        xsjg: {
          x: Object.keys(data[19].data.data),
          data: Object.values(data[19].data.data)
