...
export const menu = ref([
    ...
    },
    {
        ...
        children: [
            ...
            { id: "3-2", name: "人力资源部", isPick: false, level: 4 },
    ...
    { id: 4, name: "工商银行", isPick: false, children: [] ,level: 3},
    { id: 5, name: "政务服务", isPick: false, children: [] ,level: 3},
    { id: 6, name: "管委会", isPick: false, children: [] ,level: 3},
    {
        id: 7,
        name: "物流公司",
        isPick: false,
